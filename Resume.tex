...
\newcommand{\applicantemail}{gaoty94@gmail.com}
...
\cvaddress{University of Texas at Austin}{3517 N Hills Dr, F203, Austin, 78731}
...
\cventry{Jan. 2016--\\Dec. 2016}{Graduate Thesis} {Carnegie Mellon University, PA}{}{
...
\cvarray{\textbf{Software:} Microsoft Office, VASP, Aspen Plus, Aspen Customer Model, GAMS, COMSOL Multiphysics, Simulink, ChemOffice, Origin}
\cvarray{\textbf{Programming Language:} Python, Matlab, C, \LaTeX}



\section{Publications}
\cvarray {Yuzhen Ge, \textbf{Tianyu Gao}, \textit{et al}, "Highly Efficient Silica Coated CuNi Bimetallic Nanocatalyst from Reverse Microemulsion," \textit{Journal of Colloid and Interface Science}, 491 (2017): 123-132.}
